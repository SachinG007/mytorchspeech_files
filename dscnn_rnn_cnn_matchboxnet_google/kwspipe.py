...
def make_phoneme_google_generated_noise_rir_classification_pipe(local, args):
    ...
    if args.tts:
        ...
        if len(args.words)==12:
            ...
            data_folder_list = ['google30_tts_data', 'google30_google_tts']
    ...
    #     generated_positive_chunk_meta = list(
    #         td.BinaryChunkLister(
    #             '{}/data/MSRI/PRJ_HELLO/chunk_data_multilabel/GENERATED_GOOGLE_{}/{}'
    ...
    # if os.path.isfile('{}/data/MSRI/PRJ/chunk_data/SGY_rec5_detect/{}'.format(
    #         args.datablob, args.file_set)):

    #     hey_chunk_meta = list(
    #         td.BinaryChunkLister(
    #             '{}/data/MSRI/PRJ/chunk_data/SGY_rec5_detect/{}'.format(
    #                 args.datablob, args.file_set),
...
def make_phoneme_google_generated_noise_rir_classification_pipe_test(local, args):
    ...
    #     data_folder += '_v2'
    # words = args.words
    # #### data/google30_train/chunk_data_testontrain
    # for word in words:
    #     print('{}/data/{}/chunk_data_testontrain/{}/{}'.format(args.datablob, data_folder, word, args.file_set))
    #     generated_positive_chunk_meta = list(
    #         td.BinaryChunkLister(
    #             '{}/data/{}/chunk_data_testontrain/{}/{}'
    #             .format(args.datablob, data_folder, word, args.file_set),
    #             '{}/data/{}/chunk_data_testontrain/{}'
    #             .format(args.datablob, data_folder, word)))
    #     chunk_metas.append(generated_positive_chunk_meta)
