...
def main():
    ...
    for i, config in enumerate(models_config):
        ...
        i1_size = (
            sum([param.numel() for param in model['data'].parameters()])) / 1024.0 / 1024.0
        LOG.info('Model %s:  I8 size = %f', model['name'], i1_size)

        i2_size = (
            sum([param.numel() for param in model['data'].parameters()])) / 1024.0 / 1024.0
        LOG.info('Model %s:  I8 size = %f', model['name'], i2_size)
